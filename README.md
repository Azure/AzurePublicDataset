...
* [AzurePublicDatasetV2](https://github.com/Azure/AzurePublicDataset/blob/master/AzurePublicDatasetV2.md) - Trace create using data from 2019 Azure VM Workload containing information about ~2.6M VMs and 1.9B CPU Readings.
